...
export default function Footer() {
  return (
    <div className="grid mt-20 font-variation sm:grid-cols-2 sm:mt-25">
      <div className="flex">
        <div className="flex-1 xl:flex-initial pt-0.5 sm:pt-0.75 xl:pt-0 pl-0 xl:pl-10.5 xl:pr-16 pr-0 sm:pr-2">
        ...
        <div className="flex-1 sm:flex-initial border-l-0.5 border-black pt-1 pl-5 sm:pt-0.75 xl:pt-0 sm:pl-2.5 xl:pl-5 pr-0 sm:pr-2.5 xl:pr-0">
      ...
      <div className="flex">
        ...
        <div className="flex-1 sm:flex-initial xl:flex-1 flex flex-col justify-between border-l-0.5 border-black pl-5 pb-5 pt-0 sm:pt-0.5 xl:pt-0 sm:pl-2.5 xl:pl-5 sm:pb-10.75 xl:pb-10 pr-0 sm:pr-9.75 xl:pr-0">
          ...
          <div>
            <span className="block font-medium leading-3 text-black text-xxs -tracking-tight">
              © 2021 Even
            </span>
            <span className="block font-medium leading-3 text-black text-xxs -tracking-tight">
              All Rights Reserved.
