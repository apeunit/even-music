...
export default function Footer() {
  return (
    <div className="grid mt-20 font-variation sm:grid-cols-2 sm:mt-25">
      <div className="grid grid-cols-2 sm:flex">
        <div className="flex-1 xl:flex-initial pt-0.5 sm:pt-0.75 xl:pt-0 pl-0 pr-0 sm:pr-2">
          <div className="max-w-none sm:max-w-48.5 md:max-w-54.56 lg:max-w-60.62 xl:max-w-66.68 xl:w-full">
            <h5 className="font-variation-secondary block font-semibold sm:text-sm text-xs md:text-3.93 lg:text-4.37 xl:text-4.81 -tracking-0.1 leading-3.63 sm:leading-4.25 text-black">
              Even
            </h5>
      ...
      <div className="grid grid-cols-2 sm:flex">
        <div className="xl:max-w-95.9 flex-1 sm:border-l-0.5 border-black pt-5 pb-5 sm:pb-10 sm:pt-0.75 xl:pt-0 pr-1 xs:pr-0 sm:pr-2.5 pl-0 sm:pl-2.5 xl:pl-5">
          <div className="max-w-39.5 sm:max-w-54.75 md:max-w-61.59 lg:max-w-68.43 xl:max-w-75.28">
            <Span>
