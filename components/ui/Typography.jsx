...
export function Paragraph({ children }) {
  return (
    <p className="text-sm md:text-lg md:-tracking-0.28 md:leading-5.5 lg:text-xl lg:leading-6.05 lg:-tracking-0.31 xl:-tracking-0.34 xl:leading-8.25 font-normal -tracking-0.1 sm:text-base xl:text-6.18 sm:-tracking-0.25 leading-4.25 sm:leading-4.84 text-primary">
      {children}
    </p>
  );
}
